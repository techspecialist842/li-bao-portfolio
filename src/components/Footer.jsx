    ...
    <footer className="relative border-t border-white/5 py-10 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          ...
          <p className="text-[#aaa6c3] text-sm mt-1">Software Engineer · China</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          {socials.map((s) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-lg hover:border-purple-500/40 transition-all"
              title={s.label}
            >
              {s.icon}
            </motion.a>
        ...
        <p className="text-[#aaa6c3] text-xs text-center md:text-right">
